...
$data = data(array("act" => "list","catid" => DATA_CAT_M,"filter" => $_GET["condition"],"page" => $_GET["page"]));
...
<div class="list">
	...
	<div class="items" id="listList">
		...
		<a href="../../play/?cat=1&vid=<?php echo urlencode($v['id'])?>">
			<i style="background-image:url(<?php echo $v['pic']?>)"><b style="color: #fff;font-size: 0.3rem;text-align: center;"><?php echo $v['comment']?></b></i>
