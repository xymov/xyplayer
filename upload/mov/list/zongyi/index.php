...
$data = data(array("act" => "list","catid" => DATA_CAT_VA,"filter" => $_GET["condition"],"page" => $_GET["page"]));
...
<div class="list">
	...
	<div class="items" id="listList">
		...
		<a href="../../play/?cat=3&vid=<?php echo urlencode($v['id'])?>">
			<i style="background-image:url(<?php echo $v['pic']?>)"><b><?php echo $v['tag']?></b></i>
