...
<head>
    ...
    <script>
        if (_GET('p2pinfo') === "1") {
            document.write('<script type="text/javascript"  src="../../include/p2p.min.js" ><\/script>');
        } else {
...
<body>
    ...
    <script type="text/javascript">
        ...
        var id= (typeof(xyplay.title)!=='undefined' && xyplay.title.indexOf("直链")===-1) ? xyplay.title :"<?php echo substr(md5(trim(filter_input(INPUT_GET, 'url'))),8,16); ?>";
        init();
           ...
           if("undefined" !== typeof xyplay && "undefined" !== typeof xyplay.contextmenu && xyplay.contextmenu.off){
            ...
            if ("undefined" !== typeof xyplay && "undefined" !== typeof xyplay.list_array) {
                ...
                if (xyplay.list_array && xyplay.list_array.length > 0 && xyplay.list_array[0]["video"].length > 1 && live === 0) {
                    ...
                    videoObject["list"] = "video_onlist";  //video_onlist
                    //监控鼠标
                    control();
                    if (!is_mobile()) {
      ...
      $.ajax({
            ...
            success: function(data) {
                     if(data.type==='link'){ 
                          xyplay.open(data.url);
                            ...
                            player.switchVideo({url: data.url,api:  '../../dmku/',id: id + " P"+(Number(xyplay.part)+1)});
                            player.play();
            ...
            if ("undefined" !== typeof xyplay) {
                if (xyplay.title && !live) {
                    title="正在播放:【" + xyplay.title + "】part " + (Number(xyplay.part) + 1) + "-- " + xyplay.mytitle;
                   try { 
